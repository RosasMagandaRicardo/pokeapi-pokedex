...
const searchPokemon = (event) => {
    ...
    fetch(`${POKE_API}/${value.toLowerCase()}`)
...
const renderPokemonTypes = (types) => {
    ...
    types.forEach((type) => {
        ...
        typeTextElement.setAttribute("class", "type-name")
...
const renderPokemonStats = stats => {
    ...
    stats.forEach((stat) => {
        ...
        statElement.setAttribute("class", "attributes")
        pokeStats.appendChild(statElement);
    })
}

const renderNotFound = () => {
    pokeName.textContent = "No encontado";
